package com.example.android_protice18;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnWrite = (Button) findViewById(R.id.activity_btn_write);
        Button btnRead = (Button) findViewById(R.id.activity_btn_read);
